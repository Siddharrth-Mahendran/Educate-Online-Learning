              ...
              <table id="myTable" class="table table-bordered animated bounce">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-default disabled" href="releasebooking.php?id=<?php echo $row['booking_id']; ?>">Release Turf</a></td>
                        <?php } else{ ?>
                        <td><a class="btn btn-default" href="releasebooking.php?id=<?php echo $row['booking_id']; ?>">Release turf</a></td>
                        <?php } ?>
