    ...
    <div class="container">
      <div class="row">
        ...
        <div class="form-group">
          ...
          <input required type="text" class="form-control" name="service" placeholder="Service Charge">
        </div>
        ...
        <div class="form-group">
          <label for="Address">Extra charge :</label>
          <input type="text" class="form-control" name="extra_charge" placeholder="Oil">
        </div>
