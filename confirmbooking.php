<?php
    ...
    $sql1= "SELECT * FROM `turfdetail` WHERE turf_available='0'"; 
    //echo $sql;
    $res1= mysqli_query($connection,$sql1);

    $sql2= "SELECT * FROM `manager` WHERE man_available='0'"; 
    //echo $sql;
          ...
          <div class="col-md-3"></div>
           <div class="col-md-6">
              <div class="page-header">
                ...
                <p><strong>Event_type: </strong><?php echo $row['event_type']; ?></p> 
                
                
                <p><strong>Address: </strong><?php echo $row['addres']; ?></p> 
               ...
               <form action="sendmail.php?id=<?php echo $id; ?>" method="post">
                    ...
                    <div class="input-group">
                      <span class="input-group-addon"><b>Available Turf</b></span>
                        <select class="form-control" name="turf_id";>
                           <?php
                               while($row1=mysqli_fetch_assoc($res1)) {  ?> 
                            ?>
                            <option><?php echo $row1['turf_name'];?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <br>
